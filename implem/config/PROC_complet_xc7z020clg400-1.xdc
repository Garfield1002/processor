...
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { switch[0] }]; #IO_L19N_T3_VREF_35  Sch=SW0
 set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { switch[0] }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]

#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { switch[1] }]; #IO_L24P_T3_34       Sch=SW1
 set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { switch[1] }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { push[0] }]; #IO_L20N_T3_34  Sch=BTN0
 set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { push[0] }]; #IO_L4P_T0_35 Sch=btn[0]

#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { push[1] }]; #IO_L24N_T3_34  Sch=BTN1
 set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { push[1] }]; #IO_L4N_T0_35 Sch=btn[1]

#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { push[2] }]; #IO_L18P_T2_34  Sch=BTN2
 set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { push[2] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=btn[2]
...
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { switch[2] }]; #IO_L4N_T0_34        Sch=SW2
 set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { switch[2] }]; #IO_L17P_T2_34 Sch=ja_p[1]

#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { switch[3] }]; #IO_L9P_T1_DQS_34    Sch=SW3
 set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { switch[3] }]; #IO_L17N_T2_34 Sch=ja_n[1]

#set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVCMOS33} [get_ports out_en]; #No real use? Added here just to give out_en a way out
 set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { out_en }]; #IO_L7P_T1_34 Sch=ja_p[2]
...
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { cec }]; #IO_L19N_T3_VREF_35 Sch=hdmi_tx_cec
...
set_property -dict { PACKAGE_PIN K18   IOSTANDARD TMDS_33  } [get_ports { channel_n[0]} }]; #IO_L12N_T1_MRCC_35 Sch=hdmi_tx_d_n[0]
set_property -dict { PACKAGE_PIN K17   IOSTANDARD TMDS_33  } [get_ports { channel_p[0] }]; #IO_L12P_T1_MRCC_35 Sch=hdmi_tx_d_p[0]
set_property -dict { PACKAGE_PIN J19   IOSTANDARD TMDS_33  } [get_ports { channel_n[1] }]; #IO_L10N_T1_AD11N_35 Sch=hdmi_tx_d_n[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD TMDS_33  } [get_ports { channel_p[1] }]; #IO_L10P_T1_AD11P_35 Sch=hdmi_tx_d_p[1]
set_property -dict { PACKAGE_PIN H18   IOSTANDARD TMDS_33  } [get_ports { channel_n[2] }]; #IO_L14N_T2_AD4N_SRCC_35 Sch=hdmi_tx_d_n[2]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD TMDS_33  } [get_ports { channel_p[2] }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=hdmi_tx_d_p[2]
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { hpd }]; #IO_0_34 Sch=hdmi_tx_hpdn
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { scl }]; #IO_L8P_T1_AD10P_35 Sch=hdmi_tx_scl
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L8N_T1_AD10N_35 Sch=hdmi_tx_sda
...
#set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVCMOS33} [get_ports out_en]; #No real use? Added in PMOD A to give it a way out
